...
History (append-only, newest at bottom):
  ...
  2026-05-12  run   BTC 4H IS: Sharpe -2.743. BTC IS negative → skip ETH. FAIL 0/5. Archived.
  2026-05-12  note  61% win rate but payoff 0.43 — same fat-tail problem as Z-score. Return-to-band
                    signal still fires before the fat-tail extension fully completes. Small
                    recoveries don't compensate for large continuation losses when wrong.
"""
