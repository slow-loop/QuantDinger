...
History (append-only, newest at bottom):
  ...
  2026-05-12  run   BTC 4H OOS: Sharpe -1.814, PF 0.40, n=29. FAIL 0/5.
                    ETH 4H OOS: Sharpe -1.336, PF 0.65, n=44. FAIL 0/5. Archived.
  2026-05-12  note  Worse than base Fib (base had BTC OOS Sharpe +0.374). EMA50 exit
                    fires too late — holds position through reversals that EMA50 doesn't
                    flag until deep losses. 76% time-in-market inflates trade count and
                    fees. The entry mechanism retains edge; the exit problem requires a
                    different approach. Next attempt: ATR-based trailing stop from entry.
"""
