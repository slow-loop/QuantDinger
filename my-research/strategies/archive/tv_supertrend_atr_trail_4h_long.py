...
History (append-only, newest at bottom):
  ...
  2026-05-12  run   BTC 4H OOS: Sharpe -1.769, PF 0.59, n=28. FAIL 0/5.
                    ETH 4H OOS: Sharpe -0.074, PF 0.92, n=28. FAIL 0/5. Archived.
  2026-05-12  note  74% time-in-market in IS — strategy is almost always in a trade.
                    Supertrend is a trend-following mechanism. Confirmed failure in
                    2025-26 choppy regime. Frequent band flips generate excessive
                    fees (n=28 OOS trades in 1 year). Consistent with HLHB failure.
"""
